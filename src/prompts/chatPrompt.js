...
const SECURITY_DEFENSE = {
  ...
  SECURITY_RESPONSES: {
    PROMPT_INJECTION: {
      ...
      followUpQuestions: [
        "어떤 주제에 대해 궁금하신가요?",
        "특별히 알고 싶은 정보가 있으시면 말씀해주세요",
        "제가 도움을 드릴 수 있는 분야가 있으신가요?"
      ],
...
const MANDATORY_RULES = [
  ...
  "  - 추천 질문은 자연스럽고 실제 사용자가 궁금해할 만한 질문 형태로 작성하세요",
  "  - 예시: '저에게 맞는 직업은 무엇일까요?', '이 분야의 전망은 어떤가요?', '더 자세한 정보를 알 수 있을까요?'",
  "  - 잘못된 예시: 'AI에게 ~에 대해 물어보기' (기계적이고 부자연스러운 형태)",
  "  - 올바른 예시: '저에게 맞는 직업은 무엇일까요?' (자연스럽고 개인적인 질문 형태)",
...
const EXAMPLE_RESPONSE = {
  paragraphs: [
    ...
    },
    {
     ...
     followUpQuestions: [
     "탕수육의 역사적 배경에 대해 더 자세히 알 수 있을까요?",
     "한국과 중국 탕수육의 차이점은 무엇인가요?",
     "탕수육과 관련된 재미있는 문화 현상이 있나요?"
   ],
